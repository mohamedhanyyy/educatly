...
class _$AddTaskStateImpl extends _AddTaskState with DiagnosticableTreeMixin {
  ...
  final List<File>? _filePickerResult;
  @override
  List<File>? get filePickerResult {
    final value = _filePickerResult;
    if (value == null) return null;
    if (_filePickerResult is EqualUnmodifiableListView)
